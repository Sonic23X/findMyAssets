...
/** AJAX - Depreciacion **/
$routes->get('/depreciacion', 'Depreciacion::Index');
$routes->get('/depreciacion/getItems', 'Depreciacion::SearchList');
$routes->post('/depreciacion/saveDepre', 'Depreciacion::saveDepre');
